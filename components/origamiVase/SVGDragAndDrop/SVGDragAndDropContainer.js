      ...
      <div className={styles.SVGOuterContainer}>
        ...
        <div className={styles.SVGControls}>
          ...
          <div className={styles.goreInputs}>
            ...
            {displayCreasePattern && <><label htmlFor="gore-width-input">Update Crease Pattern in Real time?(disable if laggy)</label>
